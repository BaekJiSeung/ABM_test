                    ...
                    if self.colonized:
                        ...
                        if infect == 1:
                            if other.isPatient and not other.colonized: # nonsick patient
                                ...
                                self.model.cumul_sick_patients_by_HCW += 1 
...
class Goo(Environment):
    ...
    def __init__(self, unique_id, model, colonized, x, y):
        ...
        self.isGoo = True
        # Goo.__init__
        rem_days = (self.model.cleaningDay - (self.model.tau_offset_days % self.model.cleaningDay)) % self.model.cleaningDay
        self.clean_tick = rem_days * self.model.ticks_in_day
