...
beta_csv = os.path.join(data_dir, 'beta_posterior_samples_gaussian_dropFirst1.csv')
...
beta_draw_save_path = os.path.join(
    result_dir,
    f'interv_beta_draws_{data_type}{init_envc}{init_tau0}_18.csv'
)
...
beta_fig_path = os.path.join(
    result_dir,
    f'beta_draw_hist_{data_type}{init_envc}{init_tau0}_18.png'
)
...
csv_path = os.path.join(
    result_dir,
    f'interv_{variable_name}_{data_type}{init_envc}{init_tau0}_{beta_tag1}-{beta_tag2}_18.csv'
)
...
out_path = f"../result/interv_{variable_name}_summary_{data_type}{init_envc}{init_tau0}_{beta_tag1}-{beta_tag2}_18.csv"
